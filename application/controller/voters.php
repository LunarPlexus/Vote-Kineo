...
class Voters extends Controller
{
    ...
    public function index()
    {
        ...
        echo 'Message from Controller: You are in the Controller: Voters, using the method index().';
...
*/
    ...
    {
        // simple message to show where you are
        echo 'Message from Controller: You are in the Controller: Voters, using the method deleteSong().';
